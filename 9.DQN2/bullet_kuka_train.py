...
# It first samples a batch, concatenates all the tensors into a single one, computes  𝑄(𝑠𝑡,𝑎𝑡)
# and  𝑉(𝑠𝑡+1)=max𝑎𝑄(𝑠𝑡+1,𝑎), and combines them into our loss. By defition we set  𝑉(𝑠)=0
# if  𝑠 is a terminal state. We also use a target network to compute  𝑉(𝑠𝑡+1)
#  for added stability. The target network has its weights kept frozen most of the time, 
